...
const Heading = () => {
  return (
    <div className='mt-[2vw] relative'>
        ...
        <h2 className='bg-[#006699]   ml-[5vw] text[20px] md:text-[2.5vw] pl-[4vw] text-white'>Our Strength </h2>
        
        <div className='w-[50vw] absolute top-[30px] h-[0.5vw] md:top-[5vw] bg-amber-800'></div>
